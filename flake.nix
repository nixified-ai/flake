          ...
          in hci-effects.mkEffect {
            ...
            effectScript = ''
              ...
              do
                ...
                if ! nix build --option trusted-users root --option build-users-group "" --option trusted-substituters daemon --option substituters daemon --timeout 5000 github:matthewcroughan/nixtheplanet#macos-ventura-image --keep-failed -L
                then
                  upload_failure
